...
class WatchMoviesList extends StatefulWidget {
  const WatchMoviesList(this.size, {Key? key}) : super(key: key);
  final Size size;
  @override
  State<WatchMoviesList> createState() => WatchMoviesListsState();
}

class WatchMoviesListsState extends State<WatchMoviesList> {
  final Box<HiveMovieModel> watchMoviesLists =
